...
<body style='text-align:center;'>
  ...
  <table border=1 align="center">
    ...
    <tbody >
          ...
          <div align="center">
          <img alt="" src="../../../../assets/images/fuhua.jpg" width="900" height="350" >
          </div>
        ...
        <?php 
          ...
          if(!is_null($_POST['need'] && $_POST['role'])){           
            $need = $_POST['need'];
            $Role = $_POST['role'];
            $sql1 = "select * from fuhua where need LIKE '{$need}'and role LIKE '%{$Role}%' order by grades desc";
          }
