...
<body style='text-align:center;'>
  ...
  <table border=1 align="center">
    ...
    <tbody >
          ...
          <div align="center">
          <img alt="" src="../../../../assets/images/jiaofu.jpg" width="900" height="350" >
          </div>
        ...
        <?php 
          ...
          if(!is_null($_POST['need'] && $_POST['role'])){           
            $need = $_POST['need'];
            $Role = $_POST['role'];
            $sql1 = "select * from jiaofu where need LIKE '{$need}'and role LIKE '%{$Role}%' order by grades desc";
          }


          $query = $db->query($sql1);
          while ( $jiaofu =  $query->fetchObject() ) {
          
      ?>
      
          <tr>
            <td><a href="show.php?id=<?php print $jiaofu->id; ?>"><?php echo $jiaofu->title; ?></a></td>
            <td><?php echo $jiaofu->grades; ?></td>
            <td><?php echo $jiaofu->created_at; ?></td>       
          </tr> 
